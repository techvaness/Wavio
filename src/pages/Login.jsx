...
const perks = [
  ...
  { icon: Star, text: '4.9/5 from 5,000+ teams' },
]
    ...
    <div className="min-h-screen flex flex-col" style={{ fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <nav className="border-b border-[#e4e7ed] bg-white">
        <div className="flex items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-3">
            <span className="hidden sm:block text-sm text-[#475569]">Don't have an account?</span>
            <Link to="/signup" className="px-4 py-2 text-sm font-semibold text-white bg-[#4cc61e] rounded-full hover:bg-[#3aaa10] transition-all">
              Sign up free
            </Link>
            <button
      ...
      <div className="flex flex-1">
        ...
        >
          ...
          <div className="absolute top-1/2 right-8 w-40 h-40 rounded-full opacity-5" style={{ background: 'radial-gradient(circle, #4cc61e, transparent)' }} />

          {/* Content */}
          <div className="relative z-10">
            <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-3 py-1.5 mb-10">
              <span className="w-2 h-2 rounded-full bg-[#4cc61e] animate-pulse" />
              <span className="text-xs text-white/80 font-medium">Trusted by 5,000+ teams worldwide</span>
            </div>
        ...
        {/* Right panel — form */}
        <div className="flex-1 flex items-center justify-center px-4 sm:px-6 py-8 md:py-12 bg-[#f8fafc]">
          <motion.div
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <button className="flex items-center justify-center gap-2.5 px-3 py-3 rounded-xl border-2 border-[#e4e7ed] bg-white hover:border-[#1a3fbf] hover:shadow-sm transition-all text-sm font-medium text-[#0f172a]">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <span className="text-xs text-[#94a3b8] font-medium whitespace-nowrap">or sign in with email</span>
              <div className="flex-1 h-px bg-[#e4e7ed]" />
            </div>
            ...
            <p className="text-center text-sm text-[#94a3b8] mt-7">
              ...
              <Link to="/signup" className="text-[#1a3fbf] font-bold hover:underline">
                Start for free
              </Link>
            </p>
